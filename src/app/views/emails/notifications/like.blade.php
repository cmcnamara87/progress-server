...
<html>
    <head>
        ...
        <meta property="og:title" content="{{{ $like['user']['name'] }}} liked your post" />
        
        <title>{{{ $like['user']['name'] }}} liked your post</title>
        <style type="text/css">
                                                    ...
                                                    <tr>
                                                        <td valign="top" class="bodyContent">
                                                            <div mc:edit="std_content00">
                                                                <!-- <h1 class="h1">New Like</h1> -->
                                                                <!-- <h2 class="h2">Heading 2</h2> -->
                                                                <!-- <h3 class="h3">Heading 3</h3> -->
                                                                <!-- <h4 class="h4">Heading 4</h4> -->
                                                                <img style="width:40px;height:40px;float:left;margin-right:10px;margin-bottom:10px;" src="{{{ $post['user']['picture'] }}}" alt="">
                                                                {{{ $like['user']['name'] }}} has liked your post.
                                                                ...
                                                                <tr>
                                                                    <td valign="middle" class="templateButtonContent">
                                                                        <div mc:edit="std_content01">
                                                                            <a href="http://getprogress.com/#/posts/{{{ $post['id'] }}}" target="_blank">View Post</a>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                    ...
                                                    <tr>
                                                        <td valign="top">
                                                            <div mc:edit="std_footer">
                                                                <em>Copyright &copy; <?php echo date("Y"); ?> Progress, All rights reserved.</em>
                                                                <br />
                                                                <!-- *|IFNOT:ARCHIVE_PAGE|* *|LIST:DESCRIPTION|*
                                                                <br /> -->
                                                                <strong>Our mailing address is:</strong>
                                                                <br />
                                                                <a href="mailto:progress@getprogress.com">progress@getprogress.com</a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <!-- <tr>
